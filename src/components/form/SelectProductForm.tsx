...
import { Product, SelectProduct, EditProduct } from "@/lib/types"
...
const FormSchema = z.object({
    _id: z
      .string().min(2, {
    message: "Seleciona um produto para editar.",
}),
})

export function SelectProductForm({ onEnvio, produto }: EditProduct) {
  ...
  return (
    <Form {...form}>
      ...
      >
        ...
        <Button onClick={() => onEnvio(produto)} type="submit">Editar Produto</Button>
